            ...
            if (
               ...
               $idEnq=$_SESSION['id_enqueteur'];
                $store = $this->model->store(
                    $age, $sexe, $secteurActivite, $PayVil,$regularite,$epagne,$moyen,$epagneParMois,$AvenirFinancier,   
                    $vivreRetraire,$AvenirEpagne,$KnownInvest,$eft,$interet,$invpsomme,$frequence,$rassurer,$explication,
                    $freins,$suggestion,$idEnq         
                );
